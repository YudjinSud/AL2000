...
public class PrivilegedSub extends Subscriber {
    private List<Subscriber> listCard;

    public PrivilegedSub(int userId, String creditCard, float solde, int cardID, boolean blocked,
    ...
    public void addBalance(int cardId, float amount) {
        ...
        if (subscriber != null) {
            ...
            int newSolde = subscriber.setSolde(subscriber.getSolde() + amount);
