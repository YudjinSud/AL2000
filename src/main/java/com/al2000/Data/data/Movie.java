...
public class Movie {
    ...
    public boolean getAvailableQRCode() { return this.availableQRCode; }
    public void setAvailableQRCode(boolean availableQRCode) { this.availableQRCode = availableQRCode; }
